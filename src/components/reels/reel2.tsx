...
const Reel2: React.FC = () => {
    ...
    return (
        <blockquote
            ...
            data-instgrm-permalink="https://www.instagram.com/reel/C_s7EyNReMW/?utm_source=ig_embed&amp;utm_campaign=loading"
        ...
        >
            <div style={{ padding: '16px' }}>
                <a
                    href="https://www.instagram.com/reel/C_s7EyNReMW/?utm_source=ig_embed&amp;utm_campaign=loading"
                    style={{
                        background: '#FFFFFF',
                        lineHeight: '0',
                        padding: '0',
