    ...
    return (
        <>
            <blockquote
                ...
                data-instgrm-permalink="https://www.instagram.com/reel/C_vgMm8RSIZ/?utm_source=ig_embed&amp;utm_campaign=loading"
            ...
            >
                ...
                {/* ... (el resto del contenido del blockquote) ... */}
            </blockquote>
            <InstagramScript />
        </>
    );
